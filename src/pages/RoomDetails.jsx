  ...
  return  room && (
    ...
    <div className='flex flex-col md:flex-row md:justify-between mt-10'>
     ...
     <p className='text-2xl font-medium'>₹{room.pricePerNight}/night</p>
      ...
      <form className='flex flex-col flex-wrap md:flex-row items-start md:items-center 
      justify-between bg-white shadow-[0px_0px_20px_rgba(0,0,0,0.15)] p-6 rounded-xl mx-auto mt-16 max-w-6xl' >
       ...
       <button type='submit' className='bg-blue-500  hover:bg-primary-dull
       active:scale-95 transition-all text-white rounded-md max-md:w-full 
       max-md:mt-6 md:px-25 py-3 md:py-4 text-base cursor-pointer'>Check Availability </button>
      </form>
   ...
   <div className='max-w-3xl border-y border-gray-300 my-15 py-10 text-gray-500'>
    <p>The Guests will be allocated on the ground floor according to availablility.
        You get a comfortable Two bedroom apartement has a true city felling. The 
        price quoted is for two guests slot please mark the number of guests to get the exact price for groups.
   ...
   <div className='flex flex-col items-start gap-4'>
    ...
    <button className='bg-blue-500 px-6 py-2.5 mt-4 rounded text-white 
